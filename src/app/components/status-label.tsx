...
export enum Status { // enum - сховище ключів
  Active = 'active',
  NotActive = 'notActive',
  Pending = 'pending',
  Suspended = 'suspended',
...
export interface StatusLabelProps {
  children: React.ReactNode; // рядок, число, компонент або фрагмент
  status: Status;
  disabled?: boolean;
}
...
export default function StatusLabel({
  ...
  console.log(process.env.CRM_SECRET_KEY);//нічого не буде, лише в терміналі, бо серверні компоненти не рендеряться в браузері
  return (
    <div
      className={clsx(
